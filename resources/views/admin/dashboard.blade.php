...
@push('css')
    <link rel="stylesheet" href="{{asset('back/assets/vendors/flatpickr/flatpickr.min.css')}}">
...
@push('js')
    ...
    <script src="{{asset('back/assets/vendors/flatpickr/flatpickr.min.js')}}"></script>
    <script src="{{asset('back/assets/vendors/apexcharts/apexcharts.min.js')}}"></script>
@endpush
