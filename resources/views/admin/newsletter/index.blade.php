                        ...
                        <table class="table table-hover align-middle">
                            ...
                            @forelse($newsletters as $newsletter)
                                <tr>
                                    ...
                                    <td>
                                        <span class="fw-bold text-body text-truncate d-inline-block"
                                              style="max-width: 250px;" title="{{ $newsletter->title }}">
                                            {{ $newsletter->title }}
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <form action="{{route('admin.newsletter.destroy', $newsletter->id)}}"
