...
@section('title', 'Digital Catalog Sayfasını Düzenle')
...
@section('content')
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Digital Catalog Sayfasını Düzenle</h4>
        </div>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- Form action kısmını kendi rotanıza göre güncelleyebilirsiniz. (Örn: digital_catalog.update) --}}
                    <form action="{{ route('admin.resources.digital_catalog.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="p-4 mb-4 border rounded bg-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="icon" value="{{ old('icon', $page->icon ?? 'fas fa-book-open') }}" placeholder="Örn: fas fa-book-open">
                                    <small class="text-muted">Örn: fas fa-shield-alt, fas fa-file-pdf, fas fa-book-open vb.</small>
                                </div>
                                <div class="col-md-6 mb-3">
                                        ...
                                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="pdf-lang-{{ $code }}" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-4 p-3 border rounded bg-light">
                                                    <label class="form-label fw-bold text-primary">Katalog PDF Dosyası (Flipbook İçin)</label>
                                                    ...
                                                    @if(!empty($content['pdf_url']))
                                                        <div class="mb-3">
                                                            <a href="{{ asset($content['pdf_url']) }}" target="_blank" class="btn btn-sm btn-outline-info d-inline-flex align-items-center">
                                                                <i data-lucide="external-link" class="icon-sm me-2"></i> Mevcut Kataloğu Görüntüle
                                                            </a>
                                                        </div>
                                                    @endif
