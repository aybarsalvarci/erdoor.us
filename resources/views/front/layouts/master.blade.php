...
<head>
    ...
    <title>Erdoor - WPC Solutions</title>
...
<header id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item" data-bs-interval="5000">
            <img src="{{ asset('front/assets/carousel/wider-locations.png') }}" class="hero-carousel-img d-block w-100"
                 alt="Fire Resistant">
        </div>
        <div class="carousel-item" data-bs-interval="5000">
        ...
        <div class="col-lg-10">
            ...
            <div
                ...
                <p>
                    ...
                    technology. Our <strong class="font-semibold text-gray-800">Solid Core WPC Interior Doors</strong>
                    feature realistic <strong class="font-semibold text-gray-800">wood-look finishes</strong>, superior
                    sound insulation, and exceptional resistance to moisture, humidity, termites, warping, and cracking.
                </p>
                <p>
...
<section id="products" class="container-fluid p-0 product-section">
    ...
    <div class="row g-0 product-row align-items-center">
        ...
        <div class="col-md-6 product-text-box">
            ...
            <p class="lead text-muted">With the flawless surface and elegant simplicity, SOHO transforms living spaces
    ...
    <div class="row g-0 product-row align-items-center">
        ...
        <div class="col-md-6 product-text-box">
            ...
            <p class="lead text-muted">Featuring a clean surface complemented by a sleek aluminum line, VISTA brings
                contemporary and refined aesthetics to interiors. Its elegant line offers a simple yet striking presence
    ...
    <div class="row g-0 product-row align-items-center">
        ...
        <div class="col-md-6 order-md-1 product-text-box">
            ...
            <p class="lead text-muted">The design gives the door a distinctive character, while balanced lines and
                coherent planes create a smooth rhythm within the space. Thoughtfully crafted details make the door a
    ...
    <div class="row g-0 product-row align-items-center">
        ...
        <div class="col-md-6 product-text-box">
            ...
            <p class="lead text-muted">Defined lines and balanced proportions enhance the perception of space. More than
    ...
    <div class="row g-0 product-row align-items-center">
        ...
        <div class="col-md-6 order-md-1 product-text-box">
            ...
            <p class="lead text-muted">Its refined movement system gently orchestrates the rhythm of the space. Opening
    ...
    <div class="row g-0 product-row align-items-center">
        ...
        <div class="col-md-6 product-text-box">
            ...
            <p class="lead text-muted">SIGNATURE merges advanced protection with refined aesthetic. Its fire-resistant
...
{{-- // order md 2 sağda görsel olan ürün satırı--}}
    <div class="row g-0 product-row align-items-center">
        ...
        <div class="col-md-6 order-md-1 product-text-box">
            ...
            <p class="lead text-muted">Its hidden compartment conceals cables, eliminating clutter and maintaining the
                space’s visual harmony. Flowing lines and subtle details enhance the sense of openness, while practical
