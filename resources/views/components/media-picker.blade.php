...
<style>
    ...
    .remove-btn {
        ...
        background: rgba(255, 51, 102, 0.9); color: white; border: none; border-radius: 50%;
                    ...
                    <div class="gallery-preview-container">
                        <template x-for="(item, index) in selectedItems" :key="index">
                            <div class="gallery-preview-item">
                                ...
                                <input type="hidden" :name="isMultiple ? name + '[]' : name" :value="returnType === 'url' ? item.path : item.id">
